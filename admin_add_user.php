...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO users (user_name, user_email, user_password, user_phone, user_address, user_city) 
                  VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssssss", $name, $email, $password_hash, $phone, $address, $city);
